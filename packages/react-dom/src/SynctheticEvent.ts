...
export function intiEvent(container: Container, eventType: string) {
...
function dispatchEvent(container: Container, eventType: string, e: Event) {
	...
	// 2. 构造合成事件
	const se = createSynctheticEvent(e);
	// 3. 遍历capture
...
function triggerEventFlow(paths: EventCallback[], se: SynctheticEvent) {
