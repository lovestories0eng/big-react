(function (global, factory) {
	...
	function updateWorkInProgressHook() {
	    ...
	    if (nextCurrentHook === null) {
	        ...
	        // update       u1 u2 u3 u4
	        throw new Error(`组件${currentlyRenderingFiber?.type}本次执行时的Hook比上次执行多`);
	    }
	...
	function intiEvent(container, eventType) {
	...
	function createSynctheticEvent(e) {
	    const synctheticEvent = e;
